...
const nodetype_t
    ...
    index_list_n       = { .index=INDEX_LIST,       .text="INDEX_LIST"};
...
const nodetype_t
    ...
    for_statement_n  = { .index=FOR_STATEMENT,  .text="FOR_STATEMENT" }; // Not in base language
...
const nodetype_t
    ...
    index_n       = { .index=INDEX,       .text="INDEX"} // Extention 2
...
const expression_type_t
	...
	array_index_e = { .index=ARRAY_INDEX_E, .text="ARRAY_INDEX" },
